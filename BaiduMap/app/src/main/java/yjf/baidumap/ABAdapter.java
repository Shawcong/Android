...
public class ABAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            switch (type) {
                case TYPE_A:
                    convertView = View.inflate(context, R.layout.friends_list_item, null);
                    holder1.name_cell = (TextView) convertView.findViewById(R.id.name_cell);
        ...
        switch (type) {
            case TYPE_A:
                People a = (People) o;
                holder1.name_cell.setText(a.getName());
                break;
