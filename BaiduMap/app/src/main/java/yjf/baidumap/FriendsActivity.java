...
public class FriendsActivity extends Activity{
    ...
    private ListView lvw_friends_list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        util = new DBbHelper(FriendsActivity.this);
        person = util.getAllData();

        myAdapter = new ABAdapter(FriendsActivity.this,person);
        lvw_friends_list = (ListView) findViewById(R.id.lvw_friends_list);
        lvw_friends_list.setAdapter(myAdapter);

        //发短信
        Button btn_friends_list_radar = (Button)findViewById(R.id.btn_friends_list_radar);
        ...
        //添加按钮事件
        Button btn_friends_list_add = (Button)findViewById(R.id.btn_friends_list_add);
        //建立事件
        btn_friends_list_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                final AlertDialog dlg = new AlertDialog.Builder(FriendsActivity.this).create();
                dlg.show();
                ...
                btn_dialog_ok.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        EditText txt_friend_name = (EditText) window.findViewById(R.id.txt_friend_name);

                        String name=txt_friend_name.getText().toString();
                        people.setName(name);
                        EditText txt_friend_number = (EditText)window.findViewById(R.id.txt_friend_number);
                        String number=txt_friend_number.getText().toString();
                        people.setNumber(number);
                        person.add(people);
                        //添加进数据库
                        util.insert(people);
                        dlg.cancel();
                        ABAdapter abAdapter = new ABAdapter(FriendsActivity.this,person);
                        lvw_friends_list = (ListView) findViewById(R.id.lvw_friends_list);
                        lvw_friends_list.setAdapter(abAdapter);
                    }
                });
            }
        });
        lvw_friends_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(FriendsActivity.this,FDetailActivity.class);
    ...
    public void onResume(){
        super.onResume();
        person = util.getAllData();
        ABAdapter myAdapter = new ABAdapter(FriendsActivity.this,person);
        lvw_friends_list = (ListView) findViewById(R.id.lvw_friends_list);
        lvw_friends_list.setAdapter(myAdapter);
    }
